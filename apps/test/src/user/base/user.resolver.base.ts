...
export class UserResolverBase {
  ...
  async createUser(@graphql.Args() args: CreateUserArgs): Promise<User> {
    return await this.service.createUser({
      ...
      data: {
        ...
        todos: args.data.todos
          ? {
              connect: args.data.todos,
            }
          : undefined,
      },
    });
  ...
  async getTodos(@graphql.Parent() parent: User): Promise<Task | null> {
    const result = await this.service.getTodos(parent.id);
